...
public class DataBase {
	...
	public static final String TCHICKEN = "chicken";
	public static final String TCHICKEN_DIAS_DE_VIDA = "dias_de_vida";
	...
	public static final String TFACTURA = "factura";	
	public static final String TFACTURA_DIA = "dia";	
	public static final String TFACTURA_PRODUCTO = "producto";	
	public static final String TFACTURA_PRECIO = "precio";	
	public static final String TFACTURA_CANTIDAD = "cantidad";
	public static final String TFACTURA_TIPO_OPERACION = "tipo_operacion";
